...
- **Endpoint**: `GET https://app-bqfaw566pqf5-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart`
...
async function callWebSearch(
  ...
  const response = await fetch(
    `https://app-bqfaw566pqf5-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
    {
      method: "GET",
      headers: {
