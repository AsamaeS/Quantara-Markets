...
const MOCK_NEWS_DATA: NewsArticle[] = [
  {
    ...
    url: 'https://www.bloomberg.com/news/articles/2024-01-02/tesla-sales-q4-2023-deliveries',
  ...
  },
  {
    ...
    url: 'https://www.reuters.com/technology/nvidia-unveils-new-ai-chip-2024-01-08/',
  ...
  },
  {
    ...
    url: 'https://www.cnbc.com/2024/03/20/fed-rate-decision-march-2024.html',
  ...
  },
  {
    ...
    url: 'https://www.coindesk.com/bitcoin-etfs-record-inflows-2024',
  ...
  },
  {
    ...
    url: 'https://www.wsj.com/business/mediatelecom/apple-launches-new-services-bundle-1234567890',
  ...
  },
  {
    ...
    url: 'https://www.marketwatch.com/story/microsoft-azure-growth-beats-expectations-1234567890',
  ...
  },
  {
    ...
    url: 'https://cryptoslate.com/ethereum-shanghai-upgrade/',
    urlToImage: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800',
  ...
  },
  {
    ...
    url: 'https://www.forbes.com/sites/danielpark/2024/01/15/amazon-drone-delivery-expansion/',
  ...
  {
    source: { id: null, name: 'BBC Business' },
  ...
  {
    source: { id: null, name: 'The Economist' },
    author: 'James Wilson',
    title: 'Global Economic Outlook 2024: Risks and Opportunities',
    description: 'The Economist provides a comprehensive analysis of the global economic outlook for 2024.',
    url: 'https://www.economist.com/finance-and-economics/2024/01/01/global-economic-outlook',
    urlToImage: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800',
    publishedAt: new Date(Date.now() - 22 * 60 * 60 * 1000).toISOString(),
    content: 'The global economy faces both significant risks and opportunities in 2024...',
    sentiment: 'neutral'
  },
  {
    source: { id: null, name: 'Fortune' },
    author: 'Maria Garcia',
    title: 'Fortune 500 Companies Embrace AI at Scale',
    description: 'More than 80% of Fortune 500 companies are now implementing AI technologies at scale.',
    url: 'https://fortune.com/2024/01/20/fortune-500-ai-adoption/',
    urlToImage: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800',
